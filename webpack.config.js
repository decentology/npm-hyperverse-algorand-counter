...
const configuration = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@decentology/hyperverse-algorand': path.resolve(__dirname, './node_modules/@decentology/hyperverse-algorand')
    }
  },
  externals: {
    'react': 'react',
    ...
    '@decentology/hyperverse-algorand': '@decentology/hyperverse-algorand'
  },
};
